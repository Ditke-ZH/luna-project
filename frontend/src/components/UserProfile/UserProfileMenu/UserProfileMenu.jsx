      ...
      <div className="user-profile-menu-list-container">
          ...
          <ul className="user-profile-menu-list">
              ...
              {loggedInUserID === user.id ?
                  <li className="user-profile-menu-list-element" onClick={() => onItemClick("edit")}><img
                  className="user-menu-icon" src={editProfile} alt="edit-profile-button"/><span
                  className="user-profile-menu-list-entry"></span>Edit profile</li>
              : null}
          </ul>
      </div>
    </div>
